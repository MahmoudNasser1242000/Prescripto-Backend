...
import { addDoctorSchema, doctorIdSchema, updateDoctorDatesSchema, updateDoctorSchema } from "./doctors.validation.js";
...
doctorRouter.use("/:docId/appointments", roleAccess("super-manager", "manager", "doctors"), checkDoctorId, appointmentRouter)
